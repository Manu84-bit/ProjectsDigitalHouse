...
create schema if not exists Spotify2;
use Spotify2;
...
select IdCancion from generoxcancion where IdGenero = 9;
select * from cancion order by idCancion;

#para borrar datos de una tabla (cancion) a partir de un criterio que se cumple en otra tabla.
